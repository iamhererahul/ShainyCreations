...
(function(){
  ...
  const pageMap = {
    'index.html':'dashboard','orders.html':'orders','products.html':'products',
    'content.html':'content','bulk-orders.html':'bulk-orders','franchise.html':'franchise',
    'contact.html':'contact','finance.html':'finance','analytics.html':'analytics',
    'discounts.html':'discounts','store.html':'store','reports.html':'reports',
    'settings.html':'settings',
  };
  const currentPage = pageMap[file] || 'dashboard';

  const NAV_ITEMS = [
    { key:'dashboard',   label:'Dashboard',          href:'index.html',        badge:null,
      icon:'<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/>' },
    { key:'orders',      label:'Orders',             href:'orders.html',       badge:24,
      icon:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>' },
    { key:'products',    label:'Products',           href:'products.html',     badge:null,
      icon:'<path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/>' },
    { key:'content',     label:'Content',            href:'content.html',      badge:null,
      icon:'<rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/>' },
    { key:'bulk-orders', label:'Bulk Orders',        href:'bulk-orders.html',  badge:6,
      icon:'<path d="M5 8h14M5 8a2 2 0 1 0 0-4h14a2 2 0 1 0 0 4M5 8v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8m-9 4h4"/>' },
    { key:'franchise',   label:'Franchise Requests', href:'franchise.html',    badge:2,
      icon:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>' },
    { key:'contact',     label:'Contact',            href:'contact.html',      badge:null,
      icon:'<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>' },
    { key:'finance',     label:'Finance',            href:'finance.html',      badge:null,
      icon:'<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>' },
    { key:'analytics',   label:'Analytics',          href:'analytics.html',    badge:null,
      icon:'<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>' },
    { key:'discounts',   label:'Discounts',          href:'discounts.html',    badge:null,
      icon:'<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>' },
    { key:'store',       label:'Store Locations',    href:'store.html',        badge:null,
      icon:'<path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/>' },
    { key:'reports',     label:'Reports',            href:'reports.html',      badge:null,
      icon:'<path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"/><polyline points="13 2 13 9 20 9"/>' },
    { key:'settings',    label:'Settings',           href:'settings.html',     badge:null,
  ...
  const PAGE_TITLES = {
    'dashboard':'Dashboard','orders':'Orders','products':'Products','content':'Content Library',
    'bulk-orders':'Bulk Orders','franchise':'Franchise Requests','contact':'Contact Submissions',
    'finance':'Finance','analytics':'Analytics','discounts':'Discounts','store':'Store Locations',
